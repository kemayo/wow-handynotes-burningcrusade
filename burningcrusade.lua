...
ns.RegisterPoints(ns.HELLFIRE, {
    -- Mekthorg the Wild
    [44804280] = {routes={{44804280, 46704920}}},
    [45005980] = {routes={{45005980, 46505550}}},
    [53405040] = {routes={{53405040, 49605100}}},
    [70807140] = {routes={{70807140, 68306970, 65207010, 64907630, 69207700, loop=true}}},
}, {
...
ns.RegisterPoints(ns.HELLFIRE, {
    -- Fulgorge
    [27706920] = {routes={{27706920, 31006080, 34505910, 36005310, 38205140, 42305090, 45104900, r=1, g=0, b=0}}},
    [31003700] = {routes={{31003700, 27004270, 24704820, 23605590, 23506180, r=1, g=0, b=0}}},
    [58207170] = {routes={{58207170, 51207090, 41007310, 41106520, r=1, g=0, b=0}}},
}, {
...
ns.RegisterPoints(ns.HELLFIRE, {
    -- Vorakem Doomspeaker
    [38603100] = {routes={{38603100, 42203130, r=0, g=1, b=0}}},
    [60603080] = {routes={{53802740, 60603080, 65603060, r=0, g=1, b=0}}},
    [70204440] = {routes={{70204440, 74203570, r=0, g=1, b=0}}},
    [73406000] = {routes={{71405490, 73406000, r=0, g=1, b=0}}},
}, {
...
ns.RegisterPoints(ns.ZANGARMARSH, {
    [18203140] = {routes={{10805520, 09805220, 11204640, 14804440, 15004040, 17603460, 18203140, r=1, g=0, b=0}}},
    [54803380] = {routes={{54803380, 47803000, 43603480, 41403320, 38803380, 37803840, r=1, g=0, b=0}}},
    [73603620] = {routes={{73603620, 70403740, 70203980, 72204320, 73604320, 73804660, 75204720, 77005140, 78805360, r=1, g=0, b=0}}},
}, { -- Marticar
...
ns.RegisterPoints(ns.ZANGARMARSH, {
    -- Bog Lurker
    [29002220] = {routes={{29002220, 27602320, 26402860, 23602900, 21602200, 25401940, loop=true, r=0, g=1, b=0}}},
    [50006640] = {routes={{50006640, 51006080, 49005820, 45405800, 43006000, 42206060, r=0, g=1, b=0}}},
    [82607720] = {routes={{82607720, 83007960, 85807940, 86808200, 85808480, 86608860, 85809200, r=0, g=1, b=0}}},
}, {
...
ns.RegisterPoints(ns.NAGRAND, {
    [39806940] = { -- Voidhunter Yar
        ...
        routes={{39806940, 37806620, 34206620, 32206960, 32407380, 34407720, 37607660, 39607300, loop=true, r=0, g=0, b=1}},
    },
})
ns.RegisterPoints(ns.NAGRAND, {
    -- Goretooth
    [33205100] = {routes={{33205100, 36404480, 40804290, 43204000, 45204260, 45204640, 43004780, r=0, g=1, b=0}},note="Underwater"},
    [58202780] = {note="Underwater"},
    [77608120] = {routes={{77608120, 75007620, r=0, g=1, b=0}}},
}, {
...
ns.RegisterPoints(ns.NAGRAND, {
    [25805260] = {routes={{25805260, 28803560, 32802920, 33201940, r=1, g=0.8, b=0}}},
    [50205120] = {routes={{50205120, 52805200, 53605600, 51606060, 48006180, 44005580, r=1, g=0.8, b=0}}},
    [70007000] = {routes={{70007000, 66807660, 58607300, 60807160, 60407840, 59608000, r=1, g=0.8, b=0}}},
...
ns.RegisterPoints(ns.TEROKKAR, {
    -- Doomsayer Jurim
    [36404260] = {routes={{36404260, 36204060, 35603880, 36003660, 36003360, 36603040, r=0.8, g=0, b=0.8}}},
    [53802120] = {routes={{53802120, 52802340, 50802520, 48802540, 47602680, 43402620, 42402660, 41202580, r=0.8, g=0, b=0.8}}},
    [70605000] = {routes={{70605000, 66404440, 65204040, 60403500, 58403400, 57003240, 56103330, 55403260, r=0.8, g=0, b=0.8}}},
}, {
...
ns.RegisterPoints(ns.BLADESEDGE, {
    -- Morcrush
    [61802260] = {},
    [78602980] = {routes={{78602980, 77802440, 74402340, 71602920, 71403460, r=0.8, g=0.8, b=0.8}}},
    [61805440] = {routes={{61805440, 65004920, 67604720, 71004140, r=0.8, g=0.8, b=0.8}}},
    [68207560] = {routes={{68207560, 68807200, 67206820, 67806440, r=0.8, g=0.8, b=0.8}}},
}, {
...
ns.RegisterPoints(ns.BLADESEDGE, {
    -- Hemathion
    [30004540] = {routes={{30004540, 29604980, 32605340, 31405700, r=1, g=0, b=0}}},
    [30007160] = {routes={{30007160, 28006620, 29206360, 30206600, 30206740, 31006900, r=1, g=0, b=0}}},
}, {
...
ns.RegisterPoints(ns.BLADESEDGE, {
    -- Speaker Mar'grom
    [39205660] = {routes={{39205660, 41605400, 41805600, 42605580, r=1, g=0.8, b=0}}},
    [41004880] = {routes={{41004880, 41605180, 42604940, r=1, g=0.8, b=0}}},
    [42408200] = {routes={{42408200, 45207660, 46607800, 47207520, r=1, g=0.8, b=0}}},
    [56402440] = {routes={{56402440, 56602740, 57603000, 57603340, 55803500, r=1, g=0.8, b=0}}},
}, {
...
ns.RegisterPoints(ns.SHADOWMOON, {
    ...
    [55007040] = {routes={{55007040, 56007360, 57607460, 59607020, r=1, g=0, b=0}}},
    [72006640] = {routes={{72006640, 69806680, 68006920, 65806940, 64406660, r=1, g=0, b=0}}},
    [37604440] = {routes={{37604440, 38604280, 40004360, 41804700, 45005040, 46005380, r=1, g=0, b=0}}},
    [57802400] = {routes={{57802400, 60802160, 63202260, 67202180, 66602580, 68202940, 70402940, r=1, g=0, b=0}}},
}, {
...
ns.RegisterPoints(ns.NETHERSTORM, {
    ...
    [19807000] = {routes={{19807000, 22606440, 26006540, 27606740, 26207240, 23207500, 20407340, loop=true, r=0, b=1, g=0}}},
    [30804260] = {routes={{30804260, 29804160, 29603940, 27204200, 24404160, 23604020, 24003840, r=0, b=1, g=0}}},
    [59803480] = {routes={{59803480, 61603220, 65603380, 68604180, 67804460, 64204820, 57604400, 57403920, loop=true, r=0, b=1, g=0}}},
}, {
...
ns.RegisterPoints(ns.NETHERSTORM, {
    -- Nuramoc
    [25008020] = {routes={{25008020, 34607860, 43807600, 43607100, r=1, g=0.8, b=0}}},
    [53605960] = {routes={{53605960, 59205800, 65605820, r=1, g=0.8, b=0}}},
    [32603100] = {routes={{32603100, 35201960, r=1, g=0.8, b=0}}},
}, { 
...
ns.RegisterPoints(ns.EVERSONG, {
    ...
    [62407980] = { -- Tregla
        npc=16855,
        routes={{62407980, 65207880, 67607960, 69408380, 69407880, 70607660, 68807120, 67007140, 65206720}},
    },
})
...
ns.RegisterPoints(ns.BLOODMYST, {
    ...
    [15405020] = {routes={{15405020, 14805480, 18405940, 19855520, 19204980, r=1, g=0, b=0}}},
    [20806180] = {routes={{20806180, 22405960, 21805540, 23005420, 25005320, 26005180, r=1, g=0, b=0}}},
    [36606060] = {routes={{36606060, 37006360, 40206380, 41006120, 39605820, 37805820, loop=true, r=1, g=0, b=0}},note="Patrols counterclockwise"},
}, {
        npc=22060,
